...
python /work/pi_allan_umass_edu/rsenapati/run_experiments.py --prompt_type RATIONALE --attack_type none --mitigation_type system_prompt_hardening --output_dir /work/pi_allan_umass_edu/rsenapati/data
