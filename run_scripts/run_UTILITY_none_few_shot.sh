...
#SBATCH --output=gpu_job_UTILITY_none_few_shot.out  # Name the output file with the job ID and experiment choices
...
python /work/pi_allan_umass_edu/rsenapati/run_experiments.py --prompt_type UTILITY --attack_type none --mitigation_type few_shot --output_dir /work/pi_allan_umass_edu/rsenapati/data
