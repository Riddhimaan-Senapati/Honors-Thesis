...
def extract_failed_pairs(
    ...
    pair_details = defaultdict(lambda: {"experiments_failed": []})
    ...
    for file_path in json_files:
        ...
        try:
            ...
            if failed_pairs_in_experiment:
                ...
                print(
                    f"  {experiment_name}: {len(failed_pairs_in_experiment)} failed pairs"
                )
...
def load_attack_datasets_for_text(
    attack_datasets_dir: Path,
    ...
    for attack_type in attack_types:
        ...
        try:
            ...
            for item in attack_data:
                ...
                pair_text_map[pair_key]["attacked_documents"][attack_type] = item.get(
                    "attacked_doc_text", ""
                )
