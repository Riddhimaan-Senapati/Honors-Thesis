...
#SBATCH --output=gpu_job_RATIONALE_scatter_none.out  # Name the output file with the job ID and experiment choices
...
python /work/pi_allan_umass_edu/rsenapati/run_experiments.py --prompt_type RATIONALE --attack_type scatter --mitigation_type none --output_dir /work/pi_allan_umass_edu/rsenapati/data
