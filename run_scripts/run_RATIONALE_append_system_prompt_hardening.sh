...
#SBATCH --output=gpu_job_RATIONALE_append_system_prompt_hardening.out  # Name the output file with the job ID and experiment choices
...
python /work/pi_allan_umass_edu/rsenapati/run_experiments.py --prompt_type RATIONALE --attack_type append --mitigation_type system_prompt_hardening --output_dir /work/pi_allan_umass_edu/rsenapati/data
