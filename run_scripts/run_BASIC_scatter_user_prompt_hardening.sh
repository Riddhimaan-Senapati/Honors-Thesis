...
#SBATCH --output=gpu_job_BASIC_scatter_user_prompt_hardening.out  # Name the output file with the job ID and experiment choices
...
python /work/pi_allan_umass_edu/rsenapati/run_experiments.py --prompt_type BASIC --attack_type scatter --mitigation_type user_prompt_hardening --output_dir /work/pi_allan_umass_edu/rsenapati/data
