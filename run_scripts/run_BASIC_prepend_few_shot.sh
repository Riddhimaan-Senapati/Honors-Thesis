...
#SBATCH --output=gpu_job_BASIC_prepend_few_shot.out  # Name the output file with the job ID and experiment choices
...
python /work/pi_allan_umass_edu/rsenapati/run_experiments.py --prompt_type BASIC --attack_type prepend --mitigation_type few_shot --output_dir /work/pi_allan_umass_edu/rsenapati/data
